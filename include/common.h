...
inline std::string tokenTypeToString(TokenType type) {
    switch (type) {
        ...
        case TokenType::OP_LESS_THAN:      return "OP_LESS_THAN";
        case TokenType::OP_GREATER_THAN:   return "OP_GREATER_THAN";
        case TokenType::OP_COMMA:          return "OP_COMMA";
        case TokenType::OP_STAR:           return "OP_STAR";
        case TokenType::OP_SEMICOLON:      return "OP_SEMICOLON";
...
inline std::string nodeTypeToString(NodeType type) {
    switch (type) {
        ...
        case NodeType::SELECT_CLAUSE: return "SELECT_CLAUSE";
        case NodeType::COLUMN_LIST:   return "COLUMN_LIST";
        case NodeType::COLUMN:        return "COLUMN";
        case NodeType::FROM_CLAUSE:   return "FROM_CLAUSE";
        case NodeType::TABLE_NAME:    return "TABLE_NAME";
        case NodeType::WHERE_CLAUSE:  return "WHERE_CLAUSE";
...
struct ParseTreeNode {
    ...
    ParseTreeNode(NodeType t, const std::string& v = "")
        : type(t), value(v) {}
